...
# with appreciation, this script is a slightly modified version of the following code
# used with permission:
# Copyright 2017 Tim A. D. Henderson for the https://hackthology.com/a-job-queue-in-bash.html
