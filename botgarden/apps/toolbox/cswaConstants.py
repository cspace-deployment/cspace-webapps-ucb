...
def getHeader(updateType, institution):
    ...
    <table><tr>
      ...
      <th style="width:10%; text-align:center;">Move <input type="radio" name="check-move" id="check-move"/></th>
      <th style="width:15%; text-align:center;">Don't Move  <input type="radio" name="check-move" id="check-move" checked/></th>
    </tr>"""
