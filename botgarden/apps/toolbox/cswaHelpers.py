...
"""
        ...
        <locationDate>%s</locationDate>
        <movementNote>%s</movementNote>
        <reasonForMove>urn:cspace:botgarden.cspace.berkeley.edu:vocabularies:name(actionCode):item:name(actCode02)'Moved'</reasonForMove>
        </ns2:movements_common>
        </document>
        """
        payload = payload % (
            f['locationRefname'], f['locationDate'], f['inventoryNote'])
